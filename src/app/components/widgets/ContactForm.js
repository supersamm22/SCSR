...
const ContactForm = () => {
  return (
    <div>    <div className="relative isolate bg-white">
        ...
        <div className="relative px-6 pt-24 pb-20 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <p className="mt-6 text-lg/8 text-gray-600">
              Southern Cross Smash Repairs takes pride in being able to reassure customers and make them feel at ease by offering services above and beyond what other repairers will do.
            </p>
